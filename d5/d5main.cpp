...
#ifdef _DEBUG
PYBIND11_MODULE(d5_d, m) {
#else
PYBIND11_MODULE(d5, m) {
#endif
	...
	py::class_<ULint>(m, "ULint",
		R"pbdoc( Unsigned Long Integer supports manipulation of whole numbers
				 larger than operating system maximum, e.g. 64 bits.)pbdoc")
		.def(py::init<>())
		.def(py::init<const ULint&>())
		.def(py::init<unsigned long long>(),
			R"pbdoc( Constructs unsigned long integer object 
						 initialized with the unsigned long long value.)pbdoc")
		...
		.def("toString", [](ULint& self, unsigned base) { return self.toString(base); }, "Converts unsigned long integer to string presentation for given base")
		.def("__str__", [](ULint& self) { return self.toString(); })
		.def("__repr__", [](ULint& self) { return self.toString(); })
		...
		.def("assign", static_cast<ULint & (ULint::*)(const ULint&)>(&ULint::operator=), "Assigns the value on the right to the variable on the left")
	...
	py::class_<Qexpression, Qexpression::Sp, Qstatement>(m, "Qexpression",
		...
		.def("rootDef", static_cast<Qdef & (Qexpression::*)()>(&Qexpression::rootDef),
			"returns a reference to the Q expression root Q definition")

		.def("noqbs", &Qexpression::noqbs,
		...
		.def("toString", &Qexpression::toString,
			"returns string presentation of this Q expression object")
		.def("toString", [](Qexpression& self, bool decomposed) { return self.toString(decomposed); })
		.def("toString", [](Qexpression& self) { return self.toString(); })
		.def("__str__", [](Qexpression& self) { return self.toString(); })
		.def("__repr__", [](Qexpression& self) { return self.toString(); })

		.def("add", &Qexpression::add,
			"Add a quantum evaluation to this quantum expression.")
		.def("solutions", &Qexpression::solutions,
			"For existing samples, returns a string with all solutions of this Q expression")
		.def("solve", &Qexpression::solve,
			"Solve this Q expression and return a string with all solutions")
		.def("compute", &Qexpression::compute,
			"Returns computed sample set with all solutions for the Q expression logic")
	...
	py::class_<Qexpr<Qbit>, Qexpr<Qbit>::Sp, Qexpression>(m, "QbitExpr",
		...
		.def("nand", static_cast<Qexpr<Qbit>(Qexpr<Qbit>::*)(const Qbit&) const>(&Qexpr<Qbit>::nand), "instantiate Q expression with nand logic, e.g. for Qbit with id 'x' and 'y' the expression is !('x' & 'y')")
		.def("nand", static_cast<Qexpr<Qbit>(Qexpr<Qbit>::*)(const Qexpr<Qbit>&) const>(&Qexpr<Qbit>::nand), "instantiate Q expression with nand logic, e.g. for Qbit id 'x' and [right] object the expression is !('x' & [right])")
		...
		.def("nor", static_cast<Qexpr<Qbit>(Qexpr<Qbit>::*)(const Qbit&) const>(&Qexpr<Qbit>::nor), "instantiate Q expression with nor logic, e.g. for Qbit with id 'x' and 'y' the expression is !('x' | 'y')")
		.def("nor", static_cast<Qexpr<Qbit>(Qexpr<Qbit>::*)(const Qexpr<Qbit>&) const>(&Qexpr<Qbit>::nor), "instantiate Q expression with nor logic, e.g. for Qbit id 'x' and [right] object the expression is !('x' | [right])")

		.def("unlike", static_cast<Qexpr<Qbit>(Qexpr<Qbit>::*)(const Qbit&) const>(&Qexpr<Qbit>::unlike), "instantiate Q expression with unlike logic, e.g. for Qexpr with id 'x' and 'y' the expression is 'x' ^ 'y'")
		.def("unlike", static_cast<Qexpr<Qbit>(Qexpr<Qbit>::*)(const Qexpr<Qbit>&) const>(&Qexpr<Qbit>::unlike), "instantiate Q expression with unlike logic, e.g. for Qexpr id 'x' and [right] object the expression is 'x' ^ [right]")
		...
		.def("alike", static_cast<Qexpr<Qbit>(Qexpr<Qbit>::*)(const Qbit&) const>(&Qexpr<Qbit>::alike), "instantiate Q expression with alike logic, e.g. for Qexpr with id 'x' and 'y' the expression is !('x' ^ 'y')")
		.def("alike", static_cast<Qexpr<Qbit>(Qexpr<Qbit>::*)(const Qexpr<Qbit>&) const>(&Qexpr<Qbit>::alike), "instantiate Q expression with alike logic, e.g. for Qexpr id 'x' and [right] object the expression is !('x' ^ [right])")
	...
	py::class_<Qexpr<Qbool>, Qexpr<Qbool>::Sp, Qexpression>(m, "QboolExpression",
		...
		.def("unlike", static_cast<Qexpr<Qbool>(Qexpr<Qbool>::*)(const Qbool&) const>(&Qexpr<Qbool>::unlike), "instantiate Q expression with unlike logic, e.g. for Qexpr with id 'x' and 'y' the expression is 'x' ^ 'y'")
		.def("unlike", static_cast<Qexpr<Qbool>(Qexpr<Qbool>::*)(const Qexpr<Qbool>&) const>(&Qexpr<Qbool>::unlike), "instantiate Q expression with unlike logic, e.g. for Qexpr id 'x' and [right] object the expression is 'x' ^ [right]")
		.def(py::self ^ Qbool(), "instantiate Q expression with xor logic, e.g. for Qexpr with id 'x' and 'y' the expression is 'x' ^ 'y'")
		.def(py::self ^ py::self, "instantiate Q expression with xor logic, e.g. for Qexpr id 'x' and [right] object the expression is 'x' ^ [right]")

		.def("alike", static_cast<Qexpr<Qbool>(Qexpr<Qbool>::*)(const Qbool&) const>(&Qexpr<Qbool>::alike), "instantiate Q expression with alike logic, e.g. for Qexpr with id 'x' and 'y' the expression is !('x' ^ 'y')")
		.def("alike", static_cast<Qexpr<Qbool>(Qexpr<Qbool>::*)(const Qexpr<Qbool>&) const>(&Qexpr<Qbool>::alike), "instantiate Q expression with alike logic, e.g. for Qexpr id 'x' and [right] object the expression is !('x' ^ [right])")
		.def("nxor", static_cast<Qexpr<Qbool>(Qexpr<Qbool>::*)(const Qbool&) const>(&Qexpr<Qbool>::nxor), "instantiate Q expression with nxor logic, e.g. for Qexpr with id 'x' and 'y' the expression is !('x' ^ 'y')")
		.def("nxor", static_cast<Qexpr<Qbool>(Qexpr<Qbool>::*)(const Qexpr<Qbool>&) const>(&Qexpr<Qbool>::nxor), "instantiate Q expression with nxor logic, e.g. for Qexpr id 'x' and [right] object the expression is !('x' ^ [right])")
	...
	py::class_<Qexpr<Qbin>, Qexpr<Qbin>::Sp, Qexpression>(m, "QbinExpr",
		...
		.def("nand", static_cast<Qexpr<Qbin>(Qexpr<Qbin>::*)(const Qbin&) const>(&Qexpr<Qbin>::nand), "instantiate Q expression with nand logic, e.g. for Qbin with id 'x' and 'y' the expression is !('x' & 'y')")
		.def("nand", static_cast<Qexpr<Qbin>(Qexpr<Qbin>::*)(const Qexpr<Qbin>&) const>(&Qexpr<Qbin>::nand), "instantiate Q expression with nand logic, e.g. for Qbin id 'x' and [right] object the expression is !('x' & [right])")
		...
		.def("nor", static_cast<Qexpr<Qbin>(Qexpr<Qbin>::*)(const Qbin&) const>(&Qexpr<Qbin>::nor), "instantiate Q expression with nor logic, e.g. for Qbin with id 'x' and 'y' the expression is !('x' | 'y')")
		.def("nor", static_cast<Qexpr<Qbin>(Qexpr<Qbin>::*)(const Qexpr<Qbin>&) const>(&Qexpr<Qbin>::nor), "instantiate Q expression with nor logic, e.g. for Qbin id 'x' and [right] object the expression is !('x' | [right])")
	...
	py::class_<Qassignment, Qassignment::Sp, Qstatement>(m, "Qassignment",
		...
		.def("toString", [](Qassignment& self, bool decomposed) { return self.toString(decomposed); })
		.def("toString", [](Qassignment& self) { return self.toString(); })
		.def("__str__", [](Qassignment& self) { return self.toString(); })
		.def("__repr__", [](Qassignment& self) { return self.toString(); })
	...
	py::class_<Qblock, Qblock::Sp, Qstatement>(m, "Qblock",
		R"pbdoc( A Q block is a lexical structure of quantum code, which is grouped
				 ...
				 programming through the creation of blocks nested within other 
				 blocks)pbdoc")
		.def(py::init<>())
		.def(py::init<const Qblock&>())

		.def("noqbs", &Qblock::noqbs,
			"Returns the number of Q bits that the Q block holds")

		.def("compile", &Qblock::compile,
			"Compiles this quantum block to generate quantum solver code")

		.def("toString", &Qblock::toString,
			"returns string presentation of this Q block object")
		.def("toString", [](Qblock& o, bool decomposed)
			{ return o.toString(decomposed); })
		.def("toString", [](Qblock& o) { return o.toString(); })
		.def("__str__", [](Qblock& o) { return o.toString(); })
		.def("__repr__", [](Qblock& o) { return o.toString(); })

		.def("add", &Qblock::add,
			"Add a quantum evaluation to this Q block.")
		.def("solutions", &Qblock::solutions,
			"For existing samples, returns a string with all solutions of this Q block")
		.def("solve", &Qblock::solve,
			"Solve this Q block and return a string with all solutions")
		.def("compute", &Qblock::compute,
			"Returns computed sample set with all solutions for the Q block logic")
		...
		.def("_", [](Qblock& self, const Qexpr<Qwhole>& right)
	...
	/*--- Qdef.h definitions---*/
	m.def("AllBits", []() { return cAllBits; },
		R"pbdoc(A constant indicating all Q bits should be processed.)pbdoc");
	...
	*/
	...
	py::class_<Qbit, std::shared_ptr<Qbit> >(m, "Qbit",
		R"pbdoc( Quantum bit is in superposition state for any value 
				 except 0 and 1)pbdoc")
		...
		.def("toString", [](Qbit& self, bool decomposed) { return self.toString(decomposed); })
		.def("toString", [](Qbit& self) { return self.toString(); })
		.def("__str__", [](Qbit& self) { return self.toString(); })
		.def("__repr__", [](Qbit& self) { return self.toString(); })
		...
		/*** Assignments ***/
		.def("_", static_cast<Qassign<Qbit>(Qbit::*)(const Qbit&) const>(&Qbit::operator=),
			"assigns a value of right Q bit to this Q bit")
		.def("assign", static_cast<Qassign<Qbit>(Qbit::*)(const Qbit&) const>(&Qbit::operator=),
			"assigns a value of right Q bit to this Q bit")
		.def("_", static_cast<Qassign<Qbit>(Qbit::*)(const Qexpr<Qbit>&) const>(&Qbit::operator=),
			"assignment of an Q expression creates a Q bit assignment where this Q bit is an assignee")
		.def("assign", static_cast<Qassign<Qbit>(Qbit::*)(const Qexpr<Qbit>&) const>(&Qbit::operator=),
			"assignment of an Q expression creates a Q bit assignment where this Q bit is an assignee")


		/*** Compound Assignments ***/
		.def(py::self &= py::self,
			"change value of this object as result of and operation between this and right Q bit")
		.def(py::self &= Qexpr<Qbit>(),
			"'and assignment' of an Q expression creates a following Q bit assignment [this] = [this] & [right]")

		.def(py::self |= py::self,
			"change value of this object as result of or operation between this and right Q bit")
		.def(py::self |= Qexpr<Qbit>(),
			"'or assignment' of an Q expression creates a following Q bit assignment [this] = [this] | [right]")

		.def(py::self ^= py::self,
			"change value of this object as result of xor operation between this and right Q bit")
		.def(py::self ^= Qexpr<Qbit>(),
			"'xor assignment' of an Q expression creates a following Q bit assignment [this] = [this] ^ [right]")
		...
		.def("unlike", static_cast<Qexpr<Qbit>(Qbit::*)(const Qbit&) const>(&Qbit::unlike), "instantiate Q expression with unlike logic, e.g. for Qbit with id 'x' and 'y' the expression is 'x' ^ 'y'")
		.def("unlike", static_cast<Qexpr<Qbit>(Qbit::*)(const Qexpr<Qbit>&) const>(&Qbit::unlike), "instantiate Q expression with unlike logic, e.g. for Qbit id 'x' and [right] object the expression is 'x' ^ [right]")
		...
		.def("alike", static_cast<Qexpr<Qbit>(Qbit::*)(const Qbit&) const>(&Qbit::alike), "instantiate Q expression with alike logic, e.g. for Qbit with id 'x' and 'y' the expression is !('x' ^ 'y')")
		.def("alike", static_cast<Qexpr<Qbit>(Qbit::*)(const Qexpr<Qbit>&) const>(&Qbit::alike), "instantiate Q expression with alike logic, e.g. for Qbit id 'x' and [right] object the expression is !('x' ^ [right])")
		.def("nxor", static_cast<Qexpr<Qbit>(Qbit::*)(const Qbit&) const>(&Qbit::nxor), "instantiate Q expression with nxor logic, e.g. for Qbit with id 'x' and 'y' the expression is !('x' ^ 'y')")
		.def("nxor", static_cast<Qexpr<Qbit>(Qbit::*)(const Qexpr<Qbit>&) const>(&Qbit::nxor), "instantiate Q expression with nxor logic, e.g. for Qbit id 'x' and [right] object the expression is !('x' ^ [right])")
...
/*--- Qbool.h definitions ---*/
	py::class_<Qbool>(m, "Qbool",
		R"pbdoc( Quantum boolean is in superposition state for any value 
				 except 'F' and 'T')pbdoc")
		...
		.def("toString", [](Qbool& self, bool decomposed) { return self.toString(decomposed); })
		.def("toString", [](Qbool& self) { return self.toString(); })
		.def("__str__", [](Qbool& self) { return self.toString(); })
		.def("__repr__", [](Qbool& self) { return self.toString(); })
		...
		/*** Assignments ***/
		.def("_", static_cast<Qassign<Qbool>(Qbool::*)(const Qbool&) const>(&Qbool::operator=), "assigns a value of right Q bit to this Q bit")
		.def("assign", static_cast<Qassign<Qbool>(Qbool::*)(const Qbool&) const>(&Qbool::operator=), "assigns a value of right Q bit to this Q bit")
		.def("_", static_cast<Qassign<Qbool>(Qbool::*)(const Qexpr<Qbool>&) const>(&Qbool::operator=), "assignment of an Q expression creates a Q bit assignment where this Q bit is an assignee")
		.def("assign", static_cast<Qassign<Qbool>(Qbool::*)(const Qexpr<Qbool>&) const>(&Qbool::operator=), "assignment of an Q expression creates a Q bit assignment where this Q bit is an assignee")
		...
		.def("unlike", static_cast<Qexpr<Qbool>(Qbool::*)(const Qbool&) const>(&Qbool::unlike), "instantiate Q expression with nand unlikelogic, e.g. for Qbool with id 'x' and 'y' the expression is 'x' ^ 'y'")
		.def("unlike", static_cast<Qexpr<Qbool>(Qbool::*)(const Qexpr<Qbool>&) const>(&Qbool::unlike), "instantiate Q expression with unlike logic, e.g. for Qbool id 'x' and [right] object the expression is 'x' ^ [right]")
		...
		.def("alike", static_cast<Qexpr<Qbool>(Qbool::*)(const Qbool&) const>(&Qbool::alike), "instantiate Q expression with alike logic, e.g. for Qbool with id 'x' and 'y' the expression is !('x' ^ 'y')")
		.def("alike", static_cast<Qexpr<Qbool>(Qbool::*)(const Qexpr<Qbool>&) const>(&Qbool::alike), "instantiate Q expression with alike logic, e.g. for Qbool id 'x' and [right] object the expression is !('x' ^ [right])")
		.def("nxor", static_cast<Qexpr<Qbool>(Qbool::*)(const Qbool&) const>(&Qbool::nxor), "instantiate Q expression with nxor logic, e.g. for Qbool with id 'x' and 'y' the expression is !('x' ^ 'y')")
		.def("nxor", static_cast<Qexpr<Qbool>(Qbool::*)(const Qexpr<Qbool>&) const>(&Qbool::nxor), "instantiate Q expression with nxor logic, e.g. for Qbool id 'x' and [right] object the expression is !('x' ^ [right])")
	...
	py::class_<Bits>(m, "Bits", R"pbdoc(coresponds to a bitset of the same size and unsigned long long (64 bits))pbdoc")
		...
		.def("to_string", [](Bits& self) { return self.to_string(); })
		.def("__str__", [](Bits& self) { return self.to_string(); })
		.def("__repr__", [](Bits& self) { return self.to_string(); });

	/*--- Qbin.h definitions ---*/
	py::class_<Qbin>(m, "Qbin",
		R"pbdoc( Quantum binary is in unknown state, if any of its quantum 
				 bits is in superposition state)pbdoc")

		.def("Unknown", []() { return Qnary::cUnknown; },
			R"pbdoc(Any binary container or number is unknown, if any of its
					Q bits is in superposition state.)pbdoc")
		...
		.def("toString", [](Qbin& self, bool decomposed) { return self.toString(decomposed); })
		.def("toString", [](Qbin& self) { return self.toString(); })
		.def("__str__", [](Qbin& self) { return self.toString(); })
		.def("__repr__", [](Qbin& self) { return self.toString(); })

		.def("toQbits", [](Qbin& self) { return self.operator Qbits(); })
		.def("toBits", [](Qbin& self) { return self.operator Bits(); })
		...
		/*** Assignments ***/
		.def("_", static_cast<Qassign<Qbin>(Qbin::*)(const Qbin&) const>(&Qbin::operator=), "assigns a value of right Q creates a Q bin assignment where this Q bin is an assignee")
		.def("assign", static_cast<Qassign<Qbin>(Qbin::*)(const Qbin&) const>(&Qbin::operator=), "assigns a value of right Q creates a Q bin assignment where this Q bin is an assignee")
		.def("_", static_cast<Qassign<Qbin>(Qbin::*)(const Qexpr<Qbin>&) const>(&Qbin::operator=), "assignment of an Q expression creates a Q bin assignment where this Q bin is an assignee")
		.def("assign", static_cast<Qassign<Qbin>(Qbin::*)(const Qexpr<Qbin>&) const>(&Qbin::operator=), "assignment of an Q expression creates a Q bin assignment where this Q bin is an assignee")
		...
		.def("unlike", static_cast<Qexpr<Qbin>(Qbin::*)(const Qbin&) const>(&Qbin::unlike), "instantiate Q expression with unlike logic, e.g. for Qbin with id 'x' and 'y' the expression is 'x' ^ 'y'")
		.def("unlike", static_cast<Qexpr<Qbin>(Qbin::*)(const Qexpr<Qbin>&) const>(&Qbin::unlike), "instantiate Q expression with unlike logic, e.g. for Qbin id 'x' and [right] object the expression is 'x' ^ [right]")
		.def(py::self ^ py::self, "instantiate Q expression with xor logic, e.g. for Qbin with id 'x' and 'y' the expression is 'x' ^ 'y'")
		...
		.def("alike", static_cast<Qexpr<Qbin>(Qbin::*)(const Qbin&) const>(&Qbin::alike), "instantiate Q expression with alike logic, e.g. for Qbin with id 'x' and 'y' the expression is !('x' ^ 'y')")
		.def("alike", static_cast<Qexpr<Qbin>(Qbin::*)(const Qexpr<Qbin>&) const>(&Qbin::alike), "instantiate Q expression with alike logic, e.g. for Qbin id 'x' and [right] object the expression is !('x' ^ [right])")
		.def("nxor", static_cast<Qexpr<Qbin>(Qbin::*)(const Qbin&) const>(&Qbin::nxor), "instantiate Q expression with nxor logic, e.g. for Qbin with id 'x' and 'y' the expression is !('x' ^ 'y')")
		.def("nxor", static_cast<Qexpr<Qbin>(Qbin::*)(const Qexpr<Qbin>&) const>(&Qbin::nxor), "instantiate Q expression with nxor logic, e.g. for Qbin id 'x' and [right] object the expression is !('x' ^ [right])")
		/*** Comparison ***/
		.def(py::self == py::self, "instantiate Q comparison expression, e.g. for Qbool with id 'x' and 'y' the expression is 'x' == 'y'")
	...
	py::class_<Qwhole, Qbin>(m, "Qwhole",
		...
		.def("toString", [](Qwhole& self, bool decomposed) { return self.toString(decomposed); })
		.def("toString", [](Qwhole& self) { return self.toString(); })
		.def("__str__", [](Qwhole& self) { return self.toString(); })
		.def("__repr__", [](Qwhole& self) { return self.toString(); })
		...
		.def("assign", static_cast<Qassign<Qwhole>(Qwhole::*)(const Qwhole&) const>(&Qwhole::operator=), "assigns a value of right Q whole to this Q whole")
		...
		.def("assign", static_cast<Qassign<Qwhole>(Qwhole::*)(const Qexpr<Qwhole>&) const>(&Qwhole::operator=), "assignment of an Q expression creates a Q whole assignment where this Q whole is an assignee")
	...
	py::class_<Qint, Qbin>(m, "Qint",
		...
		.def("toString", [](Qint& self, bool decomposed) { return self.toString(decomposed); })
		.def("toString", [](Qint& self) { return self.toString(); })
		.def("__str__", [](Qint& self) { return self.toString(); })
		.def("__repr__", [](Qint& self) { return self.toString(); })

		.def("solution", &Qint::solution, "returns a solution for this object identified by id")


		/*** Assignments ***/
		.def("_", static_cast<Qassign<Qint>(Qint::*)(const Qint&) const>(&Qint::operator=), "assigns a value of right Q integer to this Q bin")
		.def("assign", static_cast<Qassign<Qint>(Qint::*)(const Qint&) const>(&Qint::operator=), "assigns a value of right Q integer to this Q bin")
		.def("_", static_cast<Qassign<Qint>(Qint::*)(const Qexpr<Qint>&) const>(&Qint::operator=), "assignment of an Q expression creates a Q integer assignment where this Q bin is an assignee")
		.def("assign", static_cast<Qassign<Qint>(Qint::*)(const Qexpr<Qint>&) const>(&Qint::operator=), "assignment of an Q expression creates a Q integer assignment where this Q bin is an assignee")
	...
	py::class_<Qroutine, Qroutine::Sp, Qstatement>(m, "Qroutine",
		...
		.def(py::init<const Qroutine&>(), "copy constructor")
		.def(py::init<const string&>(),
			"creates quantum routine with a name")
		.def(py::init<const string&, const Qbinder&>(),
			"creates a named quantum routine with a given arguments in a quantum binder")
	...
	py::class_<Qbinder>(m, "Qbinder",
		...
		.def("toString", [](Qbinder& self, bool decomposed) { return self.toString(decomposed); })
		.def("toString", [](Qbinder& self) { return self.toString(); })
		.def("__str__", [](Qbinder& self) { return self.toString(); })
		.def("__repr__", [](Qroutine& self) { return self.toString(); })
