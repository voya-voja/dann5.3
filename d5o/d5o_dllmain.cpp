...
/*--- Qsolver.h definitions ---*/
	...
	// specify C++ class->baseclass specialization
	py::class_<D5QuboSolver, Qanalyzer>(m, "D5QuboSolver")
		...
		.def("solution", static_cast<Qevaluations (D5QuboSolver::*)()>(&D5QuboSolver::solution), "return quantum evaluations, the Qevaluations can be just those with lowes assessed energy or the full set of all evaluations, depending on Qsolver initialization")
